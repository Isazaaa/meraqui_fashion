      ...
      <div className="max-w-[1200px] mx-auto bg-white rounded-xl shadow-2xl overflow-hidden p-8 md:p-12">
        ...
        <div className="customize-grid grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          <div className="customize-preview-container bg-gray-100 rounded-xl overflow-hidden shadow-inner flex items-center justify-center p-4 relative">
            <div ref={garmentImageWrapperRef} className="customize-image-wrapper relative w-full h-[600px] flex items-center justify-center">
              <img
                ref={garmentImageRef}
                src={getGarmentImage()}
          ...
          <div className="customize-controls-container p-6 md:p-8 bg-gray-50 rounded-xl shadow-lg border border-gray-100">
            <div className="customize-section mb-8 border-b pb-6 border-gray-200">
              ...
              {uploadedImage && (
                <div className="flex justify-center mt-4">
                  ...
                  >
                    <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M9 2a1 0 00-.894.553L7.382 4H4a1 0 000 2v10a2 0 002 2h8a2 0 002-2V6a1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 0 012 0v6a1 0 11-2 0V8zm6 0a1 0 11-2 0v6a1 0 112 0V8z" clipRule="evenodd"></path></svg>
                    Quitar diseño
                  </button>
                </div>
              )}
            ...
            <div className="customize-section mb-6">
              ...
              <div className="customize-options flex flex-wrap gap-3 max-h-40 overflow-y-auto pr-2 custom-scroll">
